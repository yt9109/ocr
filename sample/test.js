...
function tx_api2(){
    var app_id = 1106523015;
    var nonce_str = '20e3408a79';
    var time_stamp = Math.round(new Date().getTime()/1000);//秒级
    var app_key = 'Dmw1D3ZnLPzO1606';
    var fs=require('fs');
    var imageFile = fs.readFileSync("./1497687868230.jpg");
    var image = new Buffer(imageFile).toString('base64');
    // console.log(image);
    // var image = `ooooAKKKKACiiigAooooAKKKKACiiigAooooA//9k=`;
    var session_id = '1509333186';
    var scene = "doc";
    var source = "zh";
    var target = "en";
    //顺序排列，再拼接app_key
    var url='app_id='+app_id
    +'&image='+image
    +'&nonce_str='+nonce_str
    +'&scene='+scene
...
var params = {
        hostname: 'http://api.ai.qq.com',
        path: '/fcgi-bin/nlp/nlp_imagetranslate',
        method: 'POST',
        headers: {
...
function tx_api(){
    ...
    var textOld = '中文';
    // var type = 0;
    text= encodeURI(textOld);
    console.log(encodeURI(textOld));
    // alert(encodeURIComponent(text)=='%E8%85%BE%E8%AE%AF%E5%BC%80%E6%94%BE%E5%B9%B3%E5%8F%B0');
    var time_stamp = Math.round(new Date().getTime()/1000);//秒级
    // alert(time_stamp);
    //E8F6F347D549FE514F0C9C452C95DA9D
    var app_key = 'Dmw1D3ZnLPzO1606';
    var params='app_id='+app_id+'&nonce_str=20e3408a79&text='+text+'&time_stamp='
    +time_stamp+'&type=0&app_key='+app_key;

    console.log(params);
    var sign = MD5(params).toUpperCase();
    var url = 'https://api.ai.qq.com/fcgi-bin/nlp/nlp_texttrans?'+'app_id='+app_id+'&nonce_str=20e3408a79&text='+text+'&time_stamp='
    +time_stamp+'&type=0&sign='+sign;
    getJSON(url).then(function(t){

        //'https://api.ai.qq.com/fcgi-bin/nlp/nlp_texttrans?app_id=1106523015&nonce_str=20e3408a79&text=%E4%B8%AD%E6%96%87&time_stamp=1512719436&type=0&sign=67A92F33AD5867270E3E26A92D7B4D10').then(function(t){
